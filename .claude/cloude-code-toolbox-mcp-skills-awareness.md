...
_Generated: 2026-06-13T21:37:33.272Z_
...
Workspace `mcp.json` _(folder: shamvpn)_

- **/Volumes/EXdata/work/2026/vpn_20v26/site/shamvpn/.mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **/Users/muhammad/.claude.json** — _File exists — no servers defined_
