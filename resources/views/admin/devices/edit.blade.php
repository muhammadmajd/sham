                    ...
                    <form method="POST" action="{{ route('admin.devices.update', $device) }}" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" name="device_uid" value="{{ old('device_uid', $device->device_uid) }}"
                            ...
                            <div>
                                ...
                                <select name="user_id"
                                    ...
                                    @foreach($users as $user)
                                        <option value="{{ $user->id }}" {{ (string) old('user_id', $device->user_id) === (string) $user->id ? 'selected' : '' }}>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="xray_client_uuid" value="{{ old('xray_client_uuid', $device->xray_client_uuid) }}"
                                       class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" name="xray_email" value="{{ old('xray_email', $device->xray_email) }}"
                                       class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="number" name="download_bytes" value="{{ old('download_bytes', $device->download_bytes) }}"
                                       class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                            </div>

                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Upload Bytes</label>
                                <input type="number" name="upload_bytes" value="{{ old('upload_bytes', $device->upload_bytes) }}"
                                       class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                            </div>
                        </div>
